...
//
//     final resGetProduk = resGetProdukFromJson(jsonString);

import 'dart:convert';

ResGetProduk resGetProdukFromJson(String str) =>
    ResGetProduk.fromJson(json.decode(str));

String resGetProdukToJson(ResGetProduk data) => json.encode(data.toJson());
...
class ResGetProduk {
  ...
  factory ResGetProduk.fromJson(Map<String, dynamic> json) => ResGetProduk(
...
class DataProduct {
  ...
  factory DataProduct.fromJson(Map<String, dynamic> json) => DataProduct(
        ...
        produkGrowback:
            json["produk_growback"] == null ? null : json["produk_growback"],
        produkStatus:
            json["produk_status"] == null ? null : json["produk_status"],
        produkHarga: json["produk_harga"] == null ? null : json["produk_harga"],
        produkTanggal:
            json["produk_tanggal"] == null ? null : json["produk_tanggal"],
        produkGambar:
            json["produk_gambar"] == null ? null : json["produk_gambar"],
        produkKategori:
            json["produk_kategori"] == null ? null : json["produk_kategori"],
        produkRating:
            json["produk_rating"] == null ? null : json["produk_rating"],
