...
//
//     final resKeranjang = resKeranjangFromJson(jsonString);

import 'dart:convert';

ResKeranjang resKeranjangFromJson(String str) => ResKeranjang.fromJson(json.decode(str));

String resKeranjangToJson(ResKeranjang data) => json.encode(data.toJson());
...
class ResKeranjang {
    ...
    factory ResKeranjang.fromJson(Map<String, dynamic> json) => ResKeranjang(
